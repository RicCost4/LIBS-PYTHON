...
class MyLogger:
    ...
    def __init__(self, log_name: str, log_level=logging.INFO):
    ...
    def _setup_file_handler(self, log_level):
        log_file = os.path.join(self.__class__.log_folder, f"{self.log_name}-{logging.getLevelName(log_level).lower()}.log")
